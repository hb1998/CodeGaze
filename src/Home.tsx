        ...
        <Layout className="layout">
            <Header >
                ...
                >
                    ...
                    <Menu.Item key='assessments'><Link to={'/assessments'}>Assessments</Link></Menu.Item>
                    <Menu.Item key='challenges'><Link to={'/challenges'}>Challenges</Link></Menu.Item>
                    <Menu.Item key='candidates'><Link to={'/candidates'}>Candidates</Link></Menu.Item>
                    <Menu.Item key='account' style={{ marginLeft: 'auto' }}><Link to={'/account'}>
                        Lumel &nbsp;<UserOutlined />
                    </Link></Menu.Item>
