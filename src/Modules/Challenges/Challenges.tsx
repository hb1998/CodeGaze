...
const CollectionCreateForm: React.FC<ICollectionCreateFormProps> = ({ open, onCreate, onCancel }) => {
...
const data = [
    {
        ...
        content: [
            {
                details:
                    'Challenges that an be taken in many languages and requires candidate to to return correct output',
            },
        ],
    },
    {
